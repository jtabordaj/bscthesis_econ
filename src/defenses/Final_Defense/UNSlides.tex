...
\section{Introduction and setup}
	...
	\end{frame}	
	\begin{frame}
		\frametitle{Question and Objectives}
...
\section{Theory and Literature}
	...
	\begin{frame}
		...
		\begin{itemize}
			...
			\item \textbf{Pavitt's alternative} based on \textbf{Kondratiev waves} (Archibugi, 2001).
			\item Schumpeter's focus on \textbf{Early/Late stages of an industry} (Malerba, 2005).
